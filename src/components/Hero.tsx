...
const Hero = () => {
  ...
  return (
    <section ref={containerRef} id="home" className="relative h-[300vh] bg-background">
      ...
      <div className="sticky top-0 h-screen w-full flex flex-col justify-center overflow-hidden perspective-[1200px]">
        ...
        <div className="container mx-auto px-6 relative z-10 w-full">
          <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-20 h-full">
                ...
                {[
                  ...
                  { icon: Mail, href: "mailto:sanidhyaved@gmail.com" },
                   ...
                   <a
                     ...
                     className="w-11 h-11 rounded-full border border-border bg-card/30 flex items-center justify-center text-muted-foreground hover:text-primary hover:border-primary/40 transition-all hover:scale-110 shadow-lg"
                   >
            ...
            <motion.div 
               ...
               className="flex-1 flex justify-center lg:justify-end relative h-[500px] md:h-[600px] w-full mt-20 lg:mt-0 perspective-[1000px] z-10"
            >
              
               {/* --- THE CHAIR (Behind Character) --- */}
               <motion.div 
                 style={{ y: chairY }}
                 className="absolute bottom-20 left-1/2 -translate-x-1/2 w-[180px] md:w-[220px] h-[350px] bg-gradient-to-b from-card to-background border border-border shadow-[0_20px_50px_rgba(0,0,0,0.8)] rounded-t-[50px] z-0"
               >
               ...
               <motion.div
                 ...
                 className="relative z-10 origin-bottom flex justify-center w-full"
                 animate={{ 
               ...
               >
                 ...
                 <img
                   ...
                   className="relative z-10 w-[300px] md:w-[380px] lg:w-[440px] drop-shadow-2xl object-contain object-bottom"
                 />
               </motion.div>

               {/* --- THE DESK SETUP (In front of Character) --- */}
               <div className="absolute -bottom-10 md:-bottom-20 left-1/2 -translate-x-1/2 w-[120%] h-[200px] z-20 flex justify-center perspective-[1000px] pointer-events-none">
